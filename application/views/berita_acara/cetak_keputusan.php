...
<page backtop="38mm" backbottom="10mm" backleft="15mm" backright="15mm">
    ...
    <?php
      ...
      echo substr($pb->nomor_keputusan, 0,-5)."/".substr($info_jadwal[$value]->tanggal, 0, 4);
    ?>
    </div>
    ...
    <div align="center" style="font-weight: bold; font-size: 14px;">PADA PELAKSANAAN PSKK TAHUN <?=substr($info_jadwal[$value]->tanggal, 0, 4) ?> </div>
    <hr style="width: 100%;">
    <div align="center" style="font-weight: bold; font-size: 14px; margin-top: 15px;">KETUA LSP Penulis dan Editor Profesional</div>
    <table style="width: 97%; margin-top: 25px;" border="0" class="timbangan">
    	...
    	<tr>
    		...
    		<td style="width: 75%;">
			bahwa untuk itu perlu ditetapkan dengan Surat Keputusan Ketua LSP Penulis dan Editor Profesional
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td style="width: 75%;">
				Surat Keputusan BNSP No. KEP.0135/BNSP/III/2019 tentang Lisensi kepada LSP Penulis dan Editor Profesional
    		</td>
    	</tr>
    ...
    <table style="width: 97%;" border="0" cellspacing="10" class="keputusan">
    	...
    	<tr>
    		...
    		<td style="width: 80%;">
				...
				dan melaporkan hasilnya kepada Ketua LSP Penulis dan Editor Profesional
    		</td>
    	</tr>
    	<tr>
    ...
    <div style="margin-top: 15px;">
    	<span style="text-decoration: underline;"> Tembusan :  </span> <span style="margin-left: 280px;">KETUA LSP Penulis dan Editor Profesional </span>
    </div>
    <div>
...
<page backtop="50mm" backbottom="10mm" backleft="15mm" backright="15mm">
    ...
    <table style="width: 97%; font-weight: bold; font-size: 14px; margin-top: -50px;" border="0">
    	<tr>
    		...
    		<td style="width: 5%;"> : </td>
    		<td style="width: 80%;"> Keputusan Ketua LSP Penulis dan Editor Profesional</td>
    	</tr>
    	<tr>
