    ...
    <table  border="0" style="width:100%;" >
        ...
        <tr>
            ...
            <?php foreach ($array_skema as $key => $value) { ?>
                <td style="width:77%;text-align: justify;">Surat Keputusan Kepala/Direktur <?= $aplikasi->singkatan_unit ?> Nomor: KEP 02/PSKK/LSP-PEP/V/2019 Tentang
                    Pelaksanaan Uji Kompetensi untuk <?= $value ?> di TUK <?= $tuk ?> pada Program Pelaksanaan Sertifikasi Kompetensi Kerja (PSKK)-BNSP Tahun 2019.</td>
            <?php } ?>
        </tr>
        <tr>
            ...
            <td style="width:82%;text-align: justify;">Perjanjian Program Pelaksanaan Sertifikasi Kompetensi Kerja (PSKK)
                ...
                Profesi
                (BNSP)
                dengan <?= $aplikasi->nama_unit ?> selaku Pelaksana Program PSKK, Nomor: KEP 02/PSKK/LSP-PEP/V/2019, tanggal 2 bulan Mei tahun 2019.</td>
        </tr>
        <tr>
            <td style="width:17%;vertical-align: top;"></td>
            <td style="width:5%;vertical-align: top;">2.</td>
        ...
        <tr>
            ...
            <td style="width:77%;text-align: justify;">Semua biaya yang timbul akibat dikeluarkannya Surat Perintah Tugas ini dibebankan kepada Anggaran Program Pelaksanaan Sertifikasi Kompetensi Kerja (PSKK) - BNSP Tahun 2019 melalui LSP Penulis dan Editor Profesional.</td>
        </tr>
    </table>
...
<page backtop="35mm" backbottom="20mm" backleft="20mm" backright="20mm">
    ...
    <div style="font-family: arial, sans-serif; text-transform: uppercase; font-size: 12px; padding-top:25px;">
        Yang bertanda tangan dibawah ini, Ketua LSP PEP, memberikan tugas kepada:</div>
