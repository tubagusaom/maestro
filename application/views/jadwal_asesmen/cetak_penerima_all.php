...
<page backtop="25mm" backbottom="10mm" backleft="5mm" backright="5mm">
        ...
        <table style="width: 100%; border: 0px;">
            <tr>
                ...
                <td style="text-align: center;    width: 80%;"><b><?= $konfigurasi->nama_unit ?></b><br>    
                    ...
                    Email: <?= $konfigurasi->alamat_email ?>, Website: www.lsppenuliseditor.com
                </td>
            </tr>
        </table>
    </page_header>
    ...
    <h4 style="margin-top:50px; text-align: center">DAFTAR PENERIMA ATK, KONSUMSI, DAN BAHAN UJI KOMPETENSI<br>
	...
	<td style="width:17%;"> ' . strtoupper($value->nama_lengkap) . '   <br> </td>'
        ...
        if ($noxx % 2 != 0) {
            $datax .= '<td style="width:8%;" rowspan="2"> ' . $no_urut . '......   <br> </td>
        	<td style="width:8%;" rowspan="2"> ' . ($no_urut + 1) . '......   <br> </td>
        ';
        }
        if ($noxx % 2 != 0) {
            $datax .= '<td style="width:8%;" rowspan="2"> ' . $no_urut . '......   <br> </td>
    ...
    <table style="width:100%;" border="1" cellpadding="3" cellspacing="0" >
        <tr style="font-weight:bold;">
            ...
            <td style="width:17%;text-align: center;"> NAMA LENGKAP </td>
            <td style="width:17%;text-align: center;"> ORGANISASI </td>
            <td colspan="2" style="width:8%;text-align: center;"> Tanda terima ATK </td>
            <td colspan="2" style="width:8%;text-align: center;"> Tanda terima Materi Uji </td>
            <td colspan="2" style="width:8%;text-align: center;"> Tanda terima Bahan Uji </td>
            <td colspan="2" style="width:8%;text-align: center;"> Tanda terima Konsumsi </td>
        </tr> 
        <?= $datax ?>  
    </table>
</page>